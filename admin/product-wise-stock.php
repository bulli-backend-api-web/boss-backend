        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading text-gray-900 fw-bold fs-3 my-0">Product Wise Stock</h1>
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">Product Wise Stock List</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" id="design_search" class="form-control form-control-solid w-300px ps-12" placeholder="Search Product" />
                            </div>
                        </div>
                        <a href="<?php echo $site_path; ?>/create-product-wise-stock" class="btn btn-primary"><i class="fa fa-plus"></i>Create</a>
                    </div>

                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_product_wise_stock_table">
                            <thead>
...
$(document).ready(function () {
    ...
    var table = $('#kt_product_wise_stock_table').DataTable({
        processing: true,
        serverSide: true,
        pageLength: 10,
        lengthMenu: [[10, 25, 50, 100], [10, 25, 50, 100]],
        ajax: {
            url: "<?php echo $site_path; ?>/ajax/fetch-product-wise-stock",
            type: "POST",
            data: function (d) {
