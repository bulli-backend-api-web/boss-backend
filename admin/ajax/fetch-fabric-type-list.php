...
// ================== BASE QUERY ==================
$baseQry = " FROM fabric_type WHERE 1=1 ";
$whereParts = [];
$bindTypes = "";
$bindValues = [];
...
// ================== TOTAL RECORDS ==================
$totalRecordsQuery = $con->prepare("SELECT COUNT(*) AS allcount FROM fabric_type");
...
while ($r = $result->fetch_assoc()) {
    /* Actions */
    $actions = '
        <a href="javascript:void(0);" class="btn btn-light-primary btn-sm edit-fabric-type" data-bs-toggle="modal" data-bs-target="#kt_modal_update_fabric_type" data-name="'.$r['name'].'" data-id="'.$r['id'].'"><i class="fa fa-edit">
            <span class="path1"></span>
            <span class="path2"></span>
        </i><span>Edit</span></a>&nbsp;&nbsp;<a href="#" data-action="'.$site_path.'/ajax/ajax-delete-master-data" data-id="'.$r['id'].'" class="btn btn-light-danger btn-sm delete_ftype" ><i class="fa fa-trash">
            <span class="path1"></span>
            <span class="path2"></span>
