...
$stmtTotal = $con->prepare("SELECT COUNT(*) as total FROM karigar_registration");
$stmtTotal->execute();
...
$stmtFiltered = $con->prepare("SELECT COUNT(*) as total FROM karigar_registration $where");
...
$sql = "SELECT id,firstname,middlename,lastname,mobile_number,gender,dob,doj FROM karigar_registration $where ORDER BY $orderColumn $orderDir LIMIT $start, $length";
