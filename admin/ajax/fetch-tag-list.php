...
// ================== BASE QUERY ==================
$baseQry = " FROM category WHERE 1=1 ";
$whereParts = [];
$bindTypes = "";
$bindValues = [];
...
// ================== TOTAL RECORDS ==================
$totalRecordsQuery = $con->prepare("SELECT COUNT(*) AS allcount FROM category");
...
while ($r = $result->fetch_assoc()) {
    /* Actions */
    $actions = '
        <a href="javascript:void(0);" class="btn btn-light-primary btn-sm edit-tag" data-bs-toggle="modal" data-bs-target="#kt_modal_update_tag" data-name="'.$r['name'].'" data-id="'.$r['id'].'"><i class="fa fa-edit">
            <span class="path1"></span>
            <span class="path2"></span>
        </i><span>Edit</span></a>&nbsp;&nbsp;<a href="#" data-action="'.$site_path.'/ajax/ajax-delete-master-data" data-id="'.$r['id'].'" class="btn btn-light-danger btn-sm delete_tag" ><i class="fa fa-trash">
            <span class="path1"></span>
            <span class="path2"></span>
