...
var KTSearch = function(e, t) {
    ...
    if (e) {
        var i = {
            ...
            m = function() {
                if ("menu" === n.layout && n.formElement && n.contentElement) {
				    var e = T();
...
var KTAppSidebar = function() {
    ...
    return {
        init: function() {
            var t;
            e = document.querySelector("#kt_app_sidebar_wrapper"), document.querySelector("#kt_app_sidebar"), e && (t = e.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(t, e) && e.scroll({
