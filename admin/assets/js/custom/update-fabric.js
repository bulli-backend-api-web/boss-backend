...
var KTupdateFabric = function () {
    ...
    return {
        init: function () {
            form = document.getElementById("kt_update_fabric_form");
            if (!form) return;
            ...
            submitButton = document.getElementById("kt_update_fabric_details_submit");
            bindValidation();
            ...
            submitButton.addEventListener("click", function (e) {
                ...
                validator.validate().then(function (status) {
                    if (status === "Valid") {
                        ...
                        formData.append('action', 'update-fabric');
