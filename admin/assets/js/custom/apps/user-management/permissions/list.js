    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_permissions_table")) &&
                ...
                e.querySelectorAll('[data-kt-permissions-table-filter="delete_row"]').forEach(btn => {
                    btn.addEventListener("click", function (ev) {
                        ev.preventDefault();

                        const row = ev.target.closest("tr"),
                            id = btn.getAttribute("data-id"), // make sure you add data-id="{{user_id}}" in <tr>
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                // Call AJAX
                                $.ajax({
                                    url: "http://localhost/NEW-VASTRANAND/add-update-permission",
                                    type: "POST",
                                    data: { id: id,action:'delete_permission' },
                                    dataType: "json",
