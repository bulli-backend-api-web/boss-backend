...
var KTcreateDesignDetails = function () {
    ...
    return {
        init: function () {
            form = document.getElementById("kt_create_design_form");
            submitButton = document.getElementById("kt_create_design_details_submit");
            ...
            submitButton.addEventListener("click", function (e) {
                ...
                validator.validate().then(function (status) {
                    if (status === "Valid") {
                        ...
                        let formElement = document.getElementById("kt_create_design_form");
                        let formData = new FormData(formElement);
                        let files = $('#reference')[0].files;
                        for (let i = 0; i < files.length; i++) {
                            formData.append('reference[]', files[i]);
                        }
