        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <form id="regForm" class="form staff-form" action="<?php echo $site_path; ?>/ajax/add-update-karigar-details">
                    ...
                    <input type="hidden" name="action" value="add-karigar-details"/>
                        ...
                        <div class="card" id="sec2">
                            ...
                            <div class="row col-2">
                                <div class="field fv-row mb-4">
                                    ...
                                    <select id="job_type" name="job_type" class="form-control form-control-lg form-control-solid" required>
                                        ...
                                        <option value="1">Farma Master</option>
                                        <option value="2">Cutting Master</option>
                                        <option value="3">Sampler</option>
                                    </select>
                                </div>
                                <div class="field fv-row mb-4">
                                    <div class="field fv-row mb-4">
                            ...
                            <div class="row col-2">
                                <div class="field fv-row mb-4">
                                    ...
                                    <input type="text" id="speciality" name="speciality" placeholder="e.g. Zardozi, Smocking, Heavy embroidery" class="form-control form-control-lg form-control-solid"/>
                                </div>
                                <div class="field fv-row mb-4">
                                    <label>Reference (who referred</label>
                                    <input type="text" id="reference_name" name="reference_name" placeholder="staff name or other karigar name" class="form-control form-control-lg form-control-solid"/>
                                </div>
                            ...
                            <div class="row col-4">
                                <div class="field mb-4">
                                    ...
                                    <div class="increment-tabs">
                                        <button type="button" class="increment-btn active id_type" data-type="aadhar_card">Aadhar Card</button>
                                        <button type="button" class="increment-btn id_type" data-type="driving_license">Driving License</button>
                                        <button type="button" class="increment-btn id_type" data-type="voter_card">Voter / Election Card</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card" id="sec5">
                            ...
                            <div class="row col-2">
                                    ...
                                    <select name="bank_name" id="bank_name" class="form-control form-control-lg form-control-solid">
                                        ...
                                        <?php if($banks){
                                            foreach($banks as $single_bank){ ?>
                                                <option value="<?php echo $single_bank['name']; ?>"><?php echo $single_bank['name']; ?></option>
                                            <?php }
                                ...
                                <div class="fv-row field mb-4">
                                    ...
                                    <input type="text" id="branch_name" name="branch_name" placeholder="Branch Name" class="form-control form-control-lg form-control-solid"/>
                                </div>
                            </div>
                            <div class="row col-3">
                                <div class="fv-row field mb-4">
                                    <label>IFSC Code <span class="req">*</span></label>
                                    <input type="text" id="ifsc_code" name="ifsc_code" placeholder="IFSC COde" maxlength="11" class="form-control form-control-lg form-control-solid"/>
                                    <small id="ifsc_msg"></small>
                                </div>
                                <div class="fv-row field mb-4">
                                    <label>Account Number <span class="req">*</span></label>
                                    <input type="text" id="account_number" name="account_number" placeholder="Account Number" class="form-control form-control-lg form-control-solid"/>
                        ...
                        <div class="card" id="sec6">
                            ...
                            <div class="row col-4">
                                <div class="field mb-4">
                                    ...
                                    <div class="increment-tabs">
                                        <button type="button" class="increment-btn active" data-type="fixed_monthly_salary">Fixed monthly salary</button>
                                        <button type="button" class="increment-btn" data-type="piece_rate">Piece rate</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="fixedMonthlySalary">
                                <div class="row col-2">
                                    <div class="field mb-4">
                                        ...
                                        <input type="text" name="monthly_salary" id="monthly_salary" class="form-control form-control-lg form-control-solid" placeholder="e.g.15000">
                                    </div>
                                    <input type="hidden" name="salary_type" id="salary_type" value="fixed_monthly_salary">
                                    <div class="field mb-4">
                                ...
                                <div class="row col-3">
                                    <div class="field mb-4">
                                        <label>Work start time</label>
                                            <input type="text" name="work_start_time" id="work_start_time" placeholder="" class="form-control form-control-lg form-control-solid">
                                        </select>
                                    </div>

                                    <div class="field mb-4">
                                        <label>Work end time</label>
                                        <input type="text" name="work_end_time" id="work_end_time" placeholder="" class="form-control form-control-lg form-control-solid">
                                    </div>
                                ...
                                <div class="row col-2">
                                    <div class="field mb-4">
                                        ...
                                        <select name="weekly_off_day" id="weekly_off_day" class="form-control form-control-lg form-control-solid">
                                            ...
                                            <option value="No fixed off day">No fixed off day</option>
                                            <option value="Rotating off">Rotating off</option>
                                        </select>
                                    </div>

                                    <div class="field mb-4">
                                        <label>Holiday / off days remark</label>
                                        <input type="text" name="holiday_remarks" id="holiday_remarks" placeholder="Holiday Remarks" class="form-control form-control-lg form-control-solid">
                                    </div>
                                </div>
                                <div class="row col-2">
                                    <div class="field mb-4">
                                        <label>Remark / special conditions</label>
                                        <input type="text" name="salary_remarks" id="salary_remarks" placeholder="Remarks" class="form-control form-control-lg form-control-solid">
                                    </div>
                                </div>
                            </div>
