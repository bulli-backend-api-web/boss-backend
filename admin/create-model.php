            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form id="regForm" novalidate>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row col-3">
                                <div class="field mb-4">
                                    ...
                                    <input type="date" id="dob" name="dob" onchange="calcAge()"/>
                                </div>
                                <div class="field mb-4">
                                    <label>Age</label>
                                    <input type="text" id="age" name="age" placeholder="Auto-calculated" readonly/>
                                </div>
                            ...
                            <div class="row col-2">
                                <div class="field mb-4">
                                    ...
                                    <input type="text" id="agency" name="agency" value=""/>
                                </div>
                                <div class="field mb-4">
                    ...
                    <div class="card" id="sec2">
                        ...
                        <div class="card-body">
                            <div class="row col-2">
                                <div class="field mb-4" id="f-mobile1">
                                ...
                                <div class="field mb-4">
                                    ...
                                    <input type="tel" id="mobile2" name="mobile2" placeholder="+91 98765 00000"/>
                                </div>
                            </div>
                            <div class="row col-3">
                                ...
                                <div class="field mb-3">
                                    ...
                                    <input type="text" id="youtube" name="youtube" placeholder=""/>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row col-2">
                                <div class="field mb-4">
                                    ...
                                    <input type="text" id="panNumber" name="panNumber" placeholder="ABCDE1234F" maxlength="10"/>
                                </div>
                                <div class="field mb-4">
                                    <label>Aadhaar Card Number</label>
                                    <input type="text" id="aadhaarNumber" name="aadhaarNumber" placeholder="1234 5678 9012" maxlength="14"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row col-3">
                                ...
                                <div class="field mb-4" id="f-acNo">
                                    ...
                                    <input type="password" id="acNo" name="acNo" placeholder="Enter account number"/>
                            ...
                            <div class="row col-3">
                                ...
                                <div class="field mb-4">
                                    <label>State</label>
                                    <input type="text" id="bankState" name="bankState" placeholder="Maharashtra"/>
                                </div>
                            </div>
                            <div class="row col-3">
                                <div class="field mb-4">
                                    <label>UPI ID</label>
                                    <input type="text" id="upi" name="upi" placeholder="name@upi"/>
                                </div>
                                <div class="field mb-4">
                            ...
                            <div class="radio-cards" style="margin-bottom:16px;">
                                <label class="radio-card" onclick="setRateType('per_day')">
                                    <div style="display:flex;align-items:center;">
                                        <input type="radio" name="rateType" value="per_day" checked id="rtDay"/>
                                        <span class="radio-card-label">Per Day Rate</span>
                                    </div>
                                    <div class="radio-card-sub" id="per-day-body">
                                        <div class="field" style="margin-top:8px;">
                                            <label>Amount per day (₹)</label>
                                            <input type="number" id="amtDay" name="amtDay" placeholder="e.g. 15000" min="0"/>
                                        </div>
                                        <div class="field" style="margin-top:8px;">
                                            <label>Max Outfits per Day</label>
                                            <input type="number" id="per_day_max_outfit" name="per_day_max_outfit" placeholder="e.g. 5" min="0"/>
                                        </div>
                                    </div>
                                </label>
                                <label class="radio-card" onclick="setRateType('per_outfit')">
                                    <div style="display:flex;align-items:center;">
                                        <input type="radio" name="rateType" value="per_outfit" id="rtOutfit"/>
                                    ...
                                    <div class="radio-card-sub" id="per-outfit-body" style="display:none;">
                                        <div class="row col-2" style="margin-top:8px;">
                                            <div class="field">
                                                ...
                                                <input type="number" id="amtOutfit" name="amtOutfit" placeholder="e.g. 3000" min="0"/>
                                            </div>
                                            <div class="field">
                                                <label>Max Outfits per Day</label>
                                                <input type="number" id="maxOutfitsDay" name="maxOutfitsDay" placeholder="e.g. 5" min="0"/>
                                            </div>
                                        </div>
                                    </div>
                                </label>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row col-2">
                                <div class="field">
                                    ...
                                    <input type="text" id="hometown" name="hometown" placeholder="e.g. Mumbai, Maharashtra"/>
                                </div>
                                <div class="field">
                                    <label>Travel Notes</label>
                                    <input type="text" id="travelNotes" name="travelNotes" placeholder="e.g. Available internationally with 7-day notice"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card" id="sec7">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row col-3">
                                <div class="field"><label>A · Neck</label><input type="number" step="0.1" id="neck" name="neck" placeholder='14.5"'/></div>
                                <div class="field"><label>1 · Bust / Chest</label><input type="number" step="0.1" id="bust" name="bust" placeholder='36"'/></div>
                                <div class="field"><label>C · Under Bust</label><input type="number" step="0.1" id="underbust" name="underbust" placeholder='32"'/></div>
                            </div>
                            <div class="row col-3">
                                <div class="field"><label>2 · Natural Waist</label><input type="number" step="0.1" id="waist" name="waist" placeholder='28"'/></div>
                                <div class="field"><label>D · High Hip</label><input type="number" step="0.1" id="highHip" name="highHip" placeholder='36"'/></div>
                                <div class="field"><label>3 · Full Hip</label><input type="number" step="0.1" id="fullHip" name="fullHip" placeholder='38"'/></div>
                            </div>
                            <div class="row col-3">
                                <div class="field"><label>E · Bicep</label><input type="number" step="0.1" id="bicep" name="bicep" placeholder='12"'/></div>
                                <div class="field"><label>F · Wrist</label><input type="number" step="0.1" id="wrist" name="wrist" placeholder='6.5"'/></div>
                                <div class="field"><label>G · Thigh</label><input type="number" step="0.1" id="thigh" name="thigh" placeholder='22"'/></div>
                            </div>
                            <div class="row col-2">
                                <div class="field"><label>H · Knee</label><input type="number" step="0.1" id="knee" name="knee" placeholder='14"'/></div>
                                <div class="field"><label>I · Calf</label><input type="number" step="0.1" id="calf" name="calf" placeholder='13"'/></div>
                            </div>

                            <div class="meas-section-label">Shoulder</div>
                            <div class="row col-3">
                                <div class="field"><label>B · Shoulder Width</label><input type="number" step="0.1" id="shoulderW" name="shoulderW" placeholder='15.5"'/></div>
                                <div class="field"><label>5 · Shoulder End-End</label><input type="number" step="0.1" id="shoulderE" name="shoulderE" placeholder='16"'/></div>
                                <div class="field"><label>J · Across Back</label><input type="number" step="0.1" id="acrossBack" name="acrossBack" placeholder='14"'/></div>
                            </div>

                            <div class="meas-section-label">Lengths — Front</div>
                            <div class="row col-3">
                                <div class="field"><label>4 · Bust Apex Height</label><input type="number" step="0.1" id="bustApex" name="bustApex" placeholder='10.5"'/></div>
                                <div class="field"><label>6 · Neck-Waist (Front)</label><input type="number" step="0.1" id="nwFront" name="nwFront" placeholder='15.5"'/></div>
                                <div class="field"><label>K · Neck-Waist (Back)</label><input type="number" step="0.1" id="nwBack" name="nwBack" placeholder='16"'/></div>
                            </div>
                            <div class="row col-3">
                                <div class="field"><label>7 · Back Waist Length</label><input type="number" step="0.1" id="backWaist" name="backWaist" placeholder='16.5"'/></div>
                                <div class="field"><label>8 · Waist to Length</label><input type="number" step="0.1" id="waistLen" name="waistLen" placeholder='24"'/></div>
                                <div class="field"><label>L · Back Hip (Seat)</label><input type="number" step="0.1" id="backHip" name="backHip" placeholder='40"'/></div>
                            </div>

                            <div class="meas-section-label">Lengths — Lower Body</div>
                            <div class="row col-3">
                                <div class="field"><label>9 · Crotch Length</label><input type="number" step="0.1" id="crotch" name="crotch" placeholder='11"'/></div>
                                <div class="field"><label>M · Inseam</label><input type="number" step="0.1" id="inseam" name="inseam" placeholder='30"'/></div>
                                <div class="field"><label>10 · Arm / Sleeve</label><input type="number" step="0.1" id="sleeve" name="sleeve" placeholder='24.5"'/></div>
                            </div>
                            <div class="row col-2">
                                <div class="field"><label>P · Total Height</label><input type="number" step="0.1" id="height" name="height" placeholder="5'7&quot;"/></div>
                                <div class="field"><label>Weight <span style="font-weight:400;text-transform:none;font-size:10px;color:var(--text-3)">(optional)</span></label><input type="number" step="0.1" id="weight" name="weight" placeholder="60 kg"/></div>
                            </div>
                            <div class="row col-2">
                                <div class="field">
                                ...
                                <div class="field">
                                    ...
                                    <select id="posture" name="posture">
                                        ...
                                        <option>Slightly Forward</option>
                            ...
                            <div class="upload-grid">
                                <div>
                                    ...
                                    <label class="upload-zone">
                                        <input type="file" id="photoFiles" name="photoFiles[]" accept=".jpg,.jpeg,.png" multiple onchange="handleMedia(this, 'photo')"/>
                                ...
                                <div>
                                    ...
                                    <label class="upload-zone">
                                        <input type="file" id="videoFiles" name="videoFiles[]" accept=".mp4,.mov" multiple onchange="handleMedia(this, 'video')"/>
                                        <div class="upload-icon">🎬</div>
                                        <div class="upload-title">Upload videos</div>
                                        <div class="upload-hint">MP4, MOV · max 3 · 50 MB each</div>
                                    </label>
                                    <div class="media-grid" id="video-list"></div>
                                </div>
                                <div>
                                    <label style="display:block;margin-bottom:8px;">Documents (PDF)</label>
                                    <label class="upload-zone">
                                        <input type="file" id="pdfFiles" name="pdfFiles[]" accept=".pdf" multiple onchange="handleMedia(this, 'pdf')"/>
                                        <div class="upload-icon">📄</div>
                                        <div class="upload-title">Upload PDF Files</div>
                                        <div class="upload-hint">PDF · max 5 files · 10 MB each</div>
                                    </label>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (form) {
            $("#regForm").on("submit", function(e) {
                ...
                $.ajax({
                    url: "<?php echo $site_path; ?>/ajax/ajax-save-model-data",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
...
function handleMedia(input, type) {
    ...
    if (files.length > maxFiles) {
        alert(`You can upload maximum ${maxFiles} ${type === 'photo' ? 'photos' : 'videos'}.`);
        input.value = '';
    ...
    if (type === 'photo') {
        ...
        item.innerHTML = `
            ...
            <div class="media-preview-info">
                <div class="media-preview-name" title="${file.name}">
                    ${file.name}
                </div>
        ...
        `;
         ...
         item.innerHTML = `
            ...
            <div class="media-preview-info">
                ...
                <div class="media-preview-size">${sizeMB} MB</div>
            </div>
        `;
                }
        else if (type === 'pdf') {
            item.innerHTML = `<div style="height:180px;display:flex;align-items:center;justify-content:center;font-size:60px;background:#f8f9fa;">
                    📄
                </div>
                <div class="media-preview-info">
                    <div class="media-preview-name">${file.name}</div>
                    <div class="media-preview-size">${sizeMB} MB</div>
                    <a href="${e.target.result}" target="_blank" style="font-size:12px;">View PDF</a></div>`;
            }
